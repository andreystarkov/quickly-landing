...
$(function(){function o(o,i,n){$(o).addClass("ani "+i).attr("data-wow-delay",n)}function i(){o(".section-feature","slideInDown","0");var i=new WOW({boxClass:"ani",animateClass:"animated",mobile:!1,live:!1,offset:40});i.init()}isMobile=!1,/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)&&(isMobile=!0),$("section.wooden").each(function(){$(this).prepend('<div class="line-top"></div>'),$(this).append('<div class="line-bottom"></div>')}),$("#the-chief").css({position:"absolute",bottom:"0px",left:"0",width:"100%"}),$(".chief img").css({width:"100%"}),$("#footer").css({"padding-bottom":"0px"}),$("#footer .copyrights").css({bottom:"10px"}),$(".section-feature").each(function(o,i){$(this).css({"z-index":20-o}),o--}),isMobile?console.log("Desktop"):($(window).scroll(function(){console.log($(this).scrollTop()),$(this).scrollTop()>500?$("#top").css({position:"fixed"}).addClass("toggled animated fadeInDown").one("webkitAnimationEnd oanimationend msAnimationEnd animationend",function(o){}):($("#top").removeClass("toggled animated fadeInDown"),$("#top").css({position:"absolute"}))}),console.log("Mobile")),i()});